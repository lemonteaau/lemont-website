  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`${className} absolute bottom-2 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-2 sm:gap-4 rounded-2xl bg-black/50 border border-white/10 pb-2 px-4 shadow-lg`}
